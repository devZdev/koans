...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? new line whitespace empty string
  end
  ...
  #
  # Why? You're getting something back no matter what, even if its an empty string
  ...
  # You can stop checking character class matches immediately after the first mismatch. In alternation, we have to continue checking..
