...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    result2 = [2, 3, 4].inject(6) { |product, item| product * item }
    
    assert_equal 144, result2

    # Extra Credit:
    # Describe in your own words what inject does.
    # It stores the inject arg in the first block argument. Then we iterate. The output of the executed block becomes the first block argument of the subsequent iteration. 
  end
  ...
  #   # code to read 'file'
  #
    #variable scoping or we didn't want the file variable hanging around....hmm
